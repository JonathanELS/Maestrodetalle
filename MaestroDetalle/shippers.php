                    ...
                    <div class="large-12 medium-4 cell">
                        <table id="lista" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $filas = $conn->ejecutar_consulta(comandoDML::GenerarSentenciaSelect("shippers", "*"));

                                if (count($filas) > 0) {
                                    foreach ($filas as $fila) {
                                        echo "<tr class='table-expand-row' data-open-details>"
                                        . "<td>"
                                        . "<a href='order.php?mod=E&id=$fila[shipper_id]'>Editar</a> | "
                                        . "<a href='order.php?mod=V&id=$fila[shipper_id]'>Ver</a>"
                                        . "</td>"
                                        . "<td>$fila[shipper_id]</td>"
